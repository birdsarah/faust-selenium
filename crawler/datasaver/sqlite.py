...
thread_pool_crawl_requests = ThreadPoolExecutor(max_workers=1)
thread_pool_crawl_results = ThreadPoolExecutor(max_workers=1)
thread_pool_logs = ThreadPoolExecutor(max_workers=1)
thread_pool_webext_starts = ThreadPoolExecutor(max_workers=1)
thread_pool_javascript = ThreadPoolExecutor(max_workers=1)
thread_pool_javascript_cookies = ThreadPoolExecutor(max_workers=1)
thread_pool_navigations = ThreadPoolExecutor(max_workers=1)
thread_pool_http_requests = ThreadPoolExecutor(max_workers=1)
thread_pool_http_responses = ThreadPoolExecutor(max_workers=1)
thread_pool_http_responses_content = ThreadPoolExecutor(max_workers=1)
thread_pool_http_redirects = ThreadPoolExecutor(max_workers=1)
...
DATABASE_NAME = get_manager_config('database_name')
...
async def crawl_request_to_sql(stream):
    ...
    async for batch in stream.take(20, within=5):
        ...
        _atomic_add(thread_pool_crawl_requests, items, t)
...
async def crawl_result_to_sql(stream):
    ...
    async for batch in stream.take(20, within=5):
        ...
        _atomic_add(thread_pool_crawl_results, items, t)
...
async def logs_to_sql(stream):
    ...
    async for batch in stream.take(100, within=10):
        ...
        _atomic_add(thread_pool_logs, items, t)
...
async def webext_start_to_sql(stream):
    ...
    async for batch in stream.take(20, within=5):
        ...
        _atomic_add(thread_pool_webext_starts, items, t)
...
async def webext_javascript_to_sql(stream):
    ...
    async for batch in stream.take(100, within=10):
        ...
        _atomic_add(thread_pool_javascript, items, t)
...
async def webext_javascript_cookie_to_sql(stream):
    ...
    async for batch in stream.take(100, within=10):
        ...
        _atomic_add(thread_pool_javascript_cookies, items, t)
...
async def webext_navigation_to_sql(stream):
    ...
    async for batch in stream.take(100, within=10):
        ...
        _atomic_add(thread_pool_navigations, items, t)
...
async def webext_http_request_to_sql(stream):
    ...
    async for batch in stream.take(100, within=10):
        ...
        _atomic_add(thread_pool_http_requests, items, t)
...
async def webext_http_response_to_sql(stream):
    ...
    async for batch in stream.take(100, within=10):
        ...
        _atomic_add(thread_pool_http_responses, items, t)
...
async def webext_http_response_content_to_sql(stream):
    ...
    async for batch in stream.take(5, within=10):
        ...
        _atomic_add(thread_pool_http_responses_content, items, t)
...
async def webext_http_redirect_to_sql(stream):
    ...
    async for batch in stream.take(100, within=10):
        ...
        _atomic_add(thread_pool_http_redirects, items, t)
