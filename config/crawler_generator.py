...
win_params = dict(
    ...
    crawl_name_base='platform-comp-2-win-local',
    database_name_base='data/platform-2-win-local',
...
linux_local_params = dict(
    ...
    crawl_name_base='platform-comp-2-linux-local',
    database_name_base='data/platform-2-linux-local',
    display=':99',
)
linux_cloud_params = dict(
    ...
    crawl_name_base='platform-comp-2-linux-cloud',
    database_name_base='data/platform-2-linux-cloud',
    display=':99',
)
osx_params = dict(
    ...
    crawl_name_base='platform-comp-2-osx-local',
    database_name_base='data/platform-2-osx-local',
)
